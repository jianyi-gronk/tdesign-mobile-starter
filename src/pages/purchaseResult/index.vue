<template>
    <div class="container">
        ...
        <div class="members">
            ...
            <div class="item" v-for="member in article.members" :key="member.uid">
        ...
        <div class="footer-btns">
            <t-button class="share-btn" size="large" theme="primary" variant="outline" @click="visible = true">
        ...
        <t-popup v-model="visible" placement="bottom" style="height: 278px">
            <div class="share_window">
                ...
                <t-grid :column="0" class="grid-demo">
                    <t-grid-item v-for="item in shareList.friends" :key="item" :text="item.name" :image="item.imgUrl" />
                </t-grid>
                <div class="text">分享到社媒</div>
                <t-grid :column="0" class="grid-demo">
                    <t-grid-item v-for="item in shareList.media" :key="item" :text="item.name" :image="item.imgUrl" />
                </t-grid>
            </div>
        </t-popup>
